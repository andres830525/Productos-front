<template>
  ...
  <span class="product-name">{{ product.titulo }}</span>
  <!-- <span class="product-name">{{ product.descripcion }}</span>
  <span class="product-name">{{ product.precio }}</span> -->
  ...
  const response = await axios.get('http://api-productos.test/api/productos');
